...
function changeLanguage(lang) {
    ...
    // تحديث نص زر التقديم لو كان مقدم مسبقاً
...
if(openModalBtn && clanModal) {
    openModalBtn.addEventListener('click', (e) => {
        ...
        // منع فتح الاستمارة نهائياً لو قدم قبل كده
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const skinSources = {
        ...
        'skin_hommos': './HOMMOS_19.png',
        'skin_dbu': './dbu.png',
        'skin_divx': './DIVX_.png',
        'skin_elkhattam': './elkhattam.png',
        'skin_nova': './nova.png',
        'skin_msf': './MSF47S.png',
...
if(formElement) {
    formElement.addEventListener("submit", function(e) {
        ...
        // منع التقديم لو الجهاز مبعوت منه طلب قبل كده
        if (localStorage.getItem("xtr_global_applied")) {
        ...
        fetch(webhookURL, {
            ...
            if(response.ok) {
                // قفل التقديم نهائياً على المتصفح ده
...
window.addEventListener("DOMContentLoaded", () => {
    ...
    const skins = [
        { id: "skin_dio", path: "./itzdio.png" },
        { id: "skin_haged", path: "./haged.png" },
        { id: "skin_hommos", path: "./HOMMOS_19.png" },
        { id: "skin_dbu", path: "./dbu.png" },
        { id: "skin_divx", path: "./DIVX_.png" },
        { id: "skin_elkhattam", path: "./elkhattam.png" },
        { id: "skin_nova", path: "./nova.png" },
        { id: "skin_msf", path: "./MSF47S.png" },
